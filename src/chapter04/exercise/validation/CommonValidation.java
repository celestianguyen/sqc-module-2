...
public class CommonValidation {
    ...
    // Throws NegativeNumberException if the value is below zero
    ...
    // Parses a String to double — NumberFormatException is Java's built-in, so we just let it propagate
    ...
    // Parses a String to int — same idea
